...
spec = (
	...
	"notify_administrators_in_messages = boolean(default=True)",
	"automatically_announce_new_messages = boolean(default=False)",
	"automatically_announce_activity_in_chats = boolean(default=False)",
...
class cnf:
	def __init__(self):
		self.path = os.path.join(globalVars.appArgs.configPath, "TelegramJusti.ini")
